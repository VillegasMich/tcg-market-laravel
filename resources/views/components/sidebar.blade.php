    ...
    <ul class="space-y-2 font-medium">
      <li>
        <a href="{{ route('admin.index') }}"
          ...
          <span class="ms-3">{{ __('admin/Sidebar.dashboard') }}</span>
        </a>
      </li>
      <li>
        <a href="{{ route('admin.tcgCard.index') }}"
          ...
          <span class="flex-1 ms-3 whitespace-nowrap">{{ __('admin/Sidebar.cards') }}</span>
        </a>
      </li>
      <li>
        <a href="{{ route('admin.tcgPack.index') }}"
          ...
          <span class="flex-1 ms-3 whitespace-nowrap">{{ __('admin/Sidebar.packs') }}</span>
        </a>
      </li>
      <li>
        <a href="{{ route('admin.order.index') }}"
          ...
          <span class="flex-1 ms-3 whitespace-nowrap">{{ __('admin/Sidebar.orders') }}</span>
        </a>
      </li>
      <li>
        <a href="{{ route('admin.item.index') }}"
          ...
          <span class="flex-1 ms-3 whitespace-nowrap">{{ __('admin/Sidebar.items') }}</span>
        </a>
      </li>
      <li>
        <a href="{{ route('admin.wishList.index') }}"
          ...
          <span class="flex-1 ms-3 whitespace-nowrap">{{ __('admin/Sidebar.wishlists') }}</span>
        </a>
      </li>
      <li>
        <a href="{{ route('admin.user.index') }}"
          ...
          <span class="flex-1 ms-3 whitespace-nowrap">{{ __('admin/Sidebar.users') }}</span>
        </a>
      </li>
      <li>
        <a href="{{ route('home.index') }}"
          ...
          <span class="flex-1 ms-3 whitespace-nowrap">{{ __('admin/Sidebar.main') }}</span>
        </a>
      </li>
    </ul>
  </div>
