...
@section('content')
  <h1 class=" m-10 text-5xl font-extrabold dark:text-white text-center">{{ __('admin/TcgCard.update_title') }}</h1>
  <form class="max-w-screen-md mx-auto " method="POST"
    ...
    <div class="grid grid-cols-2 gap-4">
      ...
      <div class="mb-5">
        ...
        <input type="number" id="price" name="price" min="0" value="{{ $viewData['tcgCard']->getPrice() }}"
          required
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
      ...
      <div class="mb-5">
        ...
        <input type="date" id="launchDate" name="launchDate" value="{{ $viewData['tcgCard']->getLaunchDate() }}"
          required
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
      </div>
      <div class="mb-5">
        ...
        <select id="rarity" name="rarity" required
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
          <option {{ $viewData['tcgCard']->getRarity() == 'Amazing Rare' ? 'selected' : '' }} value="Amazing Rare">
            Amazing
            Rare</option>
          ...
          <option {{ $viewData['tcgCard']->getRarity() == 'Rare Holo GX' ? 'selected' : '' }} value="Rare Holo GX">Rare
            Holo GX</option>
          <option {{ $viewData['tcgCard']->getRarity() == 'Rare Holo LV.X' ? 'selected' : '' }}
            value="Rare Holo
          LV.X">Rare
            Holo LV.X</option>
          <option {{ $viewData['tcgCard']->getRarity() == 'Rare Holo Star' ? 'selected' : '' }}
            value="Rare Holo
          Star">Rare
            Holo Star</option>
          <option {{ $viewData['tcgCard']->getRarity() == 'Rare Holo V' ? 'selected' : '' }} value="Rare Holo V">Rare
            Holo V</option>
          <option {{ $viewData['tcgCard']->getRarity() == 'Rare Holo VMAX' ? 'selected' : '' }}
            value="Rare Holo
          VMAX">Rare
            Holo VMAX</option>
          <option {{ $viewData['tcgCard']->getRarity() == 'Rare Prime' ? 'selected' : '' }} value="Rare Prime">Rare
            Prime</option>
          <option {{ $viewData['tcgCard']->getRarity() == 'Rare Prism Star' ? 'selected' : '' }}
            value="Rare Prism
          Star">Rare
            Prism Star</option>
          ...
          <option {{ $viewData['tcgCard']->getRarity() == 'Rare Shiny' ? 'selected' : '' }} value="Rare Shiny">Rare
            Shiny</option>
          <option {{ $viewData['tcgCard']->getRarity() == 'Rare Shiny GX' ? 'selected' : '' }} value="Rare Shiny GX">
            Rare
            Shiny GX</option>
      ...
      <div class="mb-5">
        ...
        <input type="number" step="0.01" id="pullRate" name="pullRate"
          value="{{ $viewData['tcgCard']->getPullRate() }}" required
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
      </div>
      <div class="mb-5">
        <label for="language"
        ...
        <select id="language" name="language" required
          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
          <option {{ $viewData['tcgCard']->getLanguage() == 'english' ? 'selected' : '' }} value="english">
            {{ __('admin/TcgCard.english') }}
          </option>
          <option {{ $viewData['tcgCard']->getLanguage() == 'spanish' ? 'selected' : '' }} value="spanish">
            {{ __('admin/TcgCard.spanish') }}
          </option>
          <option {{ $viewData['tcgCard']->getLanguage() == 'french' ? 'selected' : '' }} value="french">
            {{ __('admin/TcgCard.french') }}</option>
          <option {{ $viewData['tcgCard']->getLanguage() == 'german' ? 'selected' : '' }} value="german">
            {{ __('admin/TcgCard.german') }}</option>
        </select>
      </div>
    ...
    <button
      class=" text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{{ __('admin/TcgCard.update') }}</button>
  </form>
@endsection
